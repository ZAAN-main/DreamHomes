...
const leadership = [
  {
    id: 1,
    title:
      "With over 25 years of experience in the real estate sector, Thomas Anderson leads DreamHomes with a focus on innovation and excellence.",
    avatar: "/images/team/thomas-anderson.webp",
    name: "Thomas Anderson",
    position: "CEO",
    description:
      "Thomas Anderson is a seasoned real estate professional with a proven track record of leadership and innovation.",
  },
  {
    id: 2,
    title:
      "Robert Harris brings extensive operational expertise to DreamHomes. As COO, he ensures smooth and efficient operations across all departments, focusing on enhacing productivity and client service.",
